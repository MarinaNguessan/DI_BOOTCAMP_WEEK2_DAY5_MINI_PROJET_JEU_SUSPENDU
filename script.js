...
/* demandons au joueur 1 de choisir un mot */
const word = prompt("Joueur 1, choisissez un mot (minimum 8 lettres) :");

/* s'assurons que le mot a au moins 8 lettres */
...
if (word.length < 8) {
    ...
    /* masquons le mot en utilisant des étoiles */
    ...
    // initialisons le compteur de chances et la liste des suppositions
  ...
  // boucle tant que le joueur a encore des chances et n'a pas deviné le mot
    ...
    while (chances > 0 && hiddenWord.indexOf('*') !== -1) {
        ...
        /* demandONS au joueur 2 de deviner une lettre */

        let letter = prompt("Joueur 2, devinez une lettre :");

        /* vérifions si la lettre a déjà été devinée */
        ...
        if (guesses.indexOf(letter) !== -1) {
            ...
            /* ajoutons la lettre aux suppositions */
            ...
            if (word.indexOf(letter) !== -1) {
                ...
                /* affichons la lettre aux bons endroits dans le mot masqué */
    ...
    /* affichons un message en fonction de la fin de la partie */
